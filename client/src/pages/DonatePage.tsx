...
export const DonatePage = (): JSX.Element => {
  ...
  return (
    <main className="relative w-full overflow-x-hidden bg-black">
      ...
      >
        <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-10 px-4 pb-16 sm:px-6 lg:grid-cols-[700px_minmax(0,1fr)] lg:gap-0 lg:px-0 lg:pb-24">
          ...
          <div className="lg:px-[53px]">
            ...
            >
              ...
              <Input
                ...
                className="h-[50px] w-full rounded-[5px] border-0 bg-[linear-gradient(90deg,rgba(5,38,152,1)_0%,rgba(17,107,248,1)_50%,rgba(33,188,238,1)_100%)] px-4 [font-family:'DM_Sans',Helvetica] text-[16px] font-bold text-white shadow-[0px_5px_20px_-2px_rgba(0,0,0,0.25)] placeholder:text-white/90 focus-visible:ring-0 focus-visible:ring-offset-0"
              />
              ...
              <div className="flex w-full justify-start">
                <Button
                  ...
                  className="h-[50px] w-[165px] rounded-[5px] border-0 bg-[linear-gradient(90deg,rgba(5,38,152,1)_0%,rgba(17,107,248,1)_50%,rgba(33,188,238,1)_100%)] px-6 py-2 [font-family:'DM_Sans',Helvetica] text-[28px] font-bold text-white shadow-[0px_5px_20px_-2px_rgba(0,0,0,0.25)] hover:opacity-95 sm:text-[32px]"
                >
                  Submit
                </Button>
              </div>
